...
Move a red rectangle using arrow keys
Rectangle cannot move outside the canvas boundaries
---------------------------------------------------------------------------*/
...
function setupBuffers() {
    ...
    const vertices = new Float32Array([
        // TRIANGLE_FAN: first vertex is shared with all triangles
...
function render() {
    ...
    gl.bindVertexArray(vao);
    gl.drawArrays(gl.TRIANGLE_FAN, 0, 4);  // 4 vertices for rectangle corners
